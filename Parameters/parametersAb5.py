...
# string parameters
f1 = 832.54          # fundamental string frequency
l = 0.223               # string length
d = 0.904e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.46e-3           # hammer mass
p = 2.749                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 6.735e10               # hammer felt stiffness
