...
# string parameters
f1 = 87.51            # fundamental string frequency
l = 1.837                 # string length
rho = 7887.             # linear string density
d = 1.117e-3            # diameter
...
# hammer parameters
m_h = 9.89e-3           # hammer mass
p = 2.282                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 5.722e8               # hammer felt stiffness
