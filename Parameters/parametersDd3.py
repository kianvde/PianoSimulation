...
# string parameters
f1 = 155.91           # fundamental string frequency
l = 1.070                # string length
...
# hammer parameters
m_h = 9.27e-3           # hammer mass
p = 2.332                  # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.943e9               # hammer felt stiffness
