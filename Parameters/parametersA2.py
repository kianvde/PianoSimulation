...
# string parameters
f1 = 110.25            # fundamental string frequency
l = 1.482                 # string length
...
# hammer parameters
m_h = 9.64e-3           # hammer mass
p = 2.296                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 9.331e8               # hammer felt stiffness
