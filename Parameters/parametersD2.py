...
# string parameters
f1 = 73.58            # fundamental string frequency
l = 1.495                 # string length
rho = 21997.             # linear string density
d = 0.982e-3            # diameter
...
# hammer parameters
m_h = 10.08e-3           # hammer mass
p = 2.277                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 3.965e8               # hammer felt stiffness
