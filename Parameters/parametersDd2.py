...
# string parameters
f1 = 77.96            # fundamental string frequency
l = 1.442                 # string length
rho = 21160.             # linear string density
d = 0.960e-3            # diameter
...
# hammer parameters
m_h = 10.02e-3           # hammer mass
p = 2.278                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 4.481e8               # hammer felt stiffness
