...
# string parameters
f1 = 882.06          # fundamental string frequency
l = 0.211               # string length
d = 0.901e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.40e-3           # hammer mass
p = 2.771                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 7.611e10               # hammer felt stiffness
