...
# string parameters
f1 = 467.19          # fundamental string frequency
l = 0.383               # string length
d = 0.941e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 8.08e-3           # hammer mass
p = 2.559                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.983e10               # hammer felt stiffness
