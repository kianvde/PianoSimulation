...
# string parameters
f1 = 104.06            # fundamental string frequency
l = 1.591                 # string length
rho = 7589.             # linear string density
d = 1.095e-3            # diameter
...
# hammer parameters
m_h = 9.70e-3           # hammer mass
p = 2.292                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 8.257e8               # hammer felt stiffness
