...
# string parameters
f1 = 588.66          # fundamental string frequency
l = 0.308               # string length
d = 0.924e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.83e-3           # hammer mass
p = 2.629                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 3.234e10               # hammer felt stiffness
