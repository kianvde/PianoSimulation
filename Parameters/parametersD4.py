...
# string parameters
f1 = 294.34          # fundamental string frequency
l = 0.590               # string length
d = 0.991e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
m_s = A * l * rhoV          # total string mass
print m_s
t_e = 730.              # string tension
...
# hammer parameters
m_h = 8.58e-3           # hammer mass
p = 2.442                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 7.457e7               # hammer felt stiffness
