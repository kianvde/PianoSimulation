...
# string parameters
f1 = 699.91          # fundamental string frequency
l = 0.262               # string length
d = 0.914e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.65e-3           # hammer mass
p = 2.687                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 4.667e10               # hammer felt stiffness
