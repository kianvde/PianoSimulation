...
# string parameters
f1 = 165.19           # fundamental string frequency
l = 1.013                # string length
...
# hammer parameters
m_h = 9.20e-3           # hammer mass
p = 2.339                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 2.196e7               # hammer felt stiffness
