...
# string parameters
f1 = 741.65          # fundamental string frequency
l = 0.249               # string length
d = 0.910e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.58e-3           # hammer mass
p = 2.708                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 5.274e10               # hammer felt stiffness
