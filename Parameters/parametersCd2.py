...
# string parameters
f1 = 69.45            # fundamental string frequency
l = 1.548                 # string length
rho = 22925.             # linear string density
d = 1.012e-3            # diameter
...
# hammer parameters
m_h = 10.14e-3           # hammer mass
p = 2.276                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 3.509e8               # hammer felt stiffness
