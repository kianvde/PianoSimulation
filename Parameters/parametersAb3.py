...
# string parameters
f1 = 208.12          # fundamental string frequency
l = 0.816               # string length
d = 1.033e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 8.96e-3           # hammer mass
p = 2.375                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 3.581e9               # hammer felt stiffness
