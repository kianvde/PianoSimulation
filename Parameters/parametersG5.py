...
# string parameters
f1 = 785.63          # fundamental string frequency
l = 0.236               # string length
d = 0.907e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.52e-3           # hammer mass
p = 2.728                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 5.960e10               # hammer felt stiffness
