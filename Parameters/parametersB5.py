...
# string parameters
f1 = 990.20          # fundamental string frequency
l = 0.190               # string length
d = 0.894e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.27e-3           # hammer mass
p = 2.816                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 9.719e10               # hammer felt stiffness
