...
# string parameters
f1 = 660.69          # fundamental string frequency
l = 0.277               # string length
d = 0.917e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.71e-3           # hammer mass
p = 2.668                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 4.130e10               # hammer felt stiffness
