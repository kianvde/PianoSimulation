...
# string parameters
f1 = 370.80          # fundamental string frequency
l = 0.475               # string length
d = 0.964e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 8.33e-3           # hammer mass
p = 2.497                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.216e10               # hammer felt stiffness
