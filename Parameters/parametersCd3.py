...
# string parameters
f1 = 138.90           # fundamental string frequency
l = 1.192                 # string length
...
# hammer parameters
m_h = 9.39e-3           # hammer mass
p = 2.318                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.522e9               # hammer felt stiffness
