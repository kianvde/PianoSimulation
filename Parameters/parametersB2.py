...
# string parameters
f1 = 123.75            # fundamental string frequency
l = 1.329                 # string length
...
# hammer parameters
m_h = 9.52e-3           # hammer mass
p = 2.306                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.192e9               # hammer felt stiffness
