...
# string parameters
f1 = 416.26          # fundamental string frequency
l = 0.426               # string length
d = 0.952e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 8.21e-3           # hammer mass
p = 2.527                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.553e10               # hammer felt stiffness
