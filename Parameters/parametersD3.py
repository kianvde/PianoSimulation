...
# string parameters
f1 = 147.17           # fundamental string frequency
l = 1.129                # string length
...
# hammer parameters
m_h = 9.33e-3           # hammer mass
p = 2.325                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.720e7               # hammer felt stiffness
