...
# string parameters
f1 = 623.69          # fundamental string frequency
l = 0.292               # string length
d = 0.921e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 7.77e-3           # hammer mass
p = 2.648                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 3.655e10               # hammer felt stiffness
