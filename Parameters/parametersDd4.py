...
# string parameters
f1 = 311.82           # fundamental string frequency
l = 0.559               # string length
d = 0.984e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 8.52e-3           # hammer mass
p = 2.455                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 8.427e9               # hammer felt stiffness
