...
# string parameters
f1 = 350.05          # fundamental string frequency
l = 0.501               # string length
d = 0.970e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
m_s = A * l * rhoV          # total string mass
print m_s
t_e = 715.              # string tension
...
# hammer parameters
m_h = 8.39e-3           # hammer mass
p = 2.482                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.076e8               # hammer felt stiffness
