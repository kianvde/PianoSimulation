...
# string parameters
f1 = 116.81            # fundamental string frequency
l = 1.403                 # string length
...
# hammer parameters
m_h = 9.58e-3           # hammer mass
p = 2.301                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 1.054e9               # hammer felt stiffness
