...
# string parameters
f1 = 233.62          # fundamental string frequency
l = 0.732               # string length
d = 1.020e-3
rhoV = 7850.
A = np.pi * (d/2.)**2
...
# hammer parameters
m_h = 8.83e-3           # hammer mass
p = 2.395                 # hammer felt stiffness exponent
b_h = 1.e-4             # fluid damping coefficient
k = 4.573e9               # hammer felt stiffness
